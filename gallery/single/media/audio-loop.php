				...
				<div class="media-content">
					...
					<?php if(bp_media_is_remote ()):?>
                                        ...
                                        <?php else:
                                            ...
                                            ?>
                                            <audio src="<?php bp_media_full_src()?> " type="audio/<?php echo gallery_get_file_extension_from_media(bp_get_the_media());?>" width="<?php echo $size['thumb']['width'];?>" height="30" > </audio>
